...
pydgn-train --config-file SYNTHETIC_CONFIGS_300PATIENCE/config_FlatNSD_Diameter.yml
pydgn-train --config-file SYNTHETIC_CONFIGS_300PATIENCE/config_FlatNSD_ECC.yml
pydgn-train --config-file SYNTHETIC_CONFIGS_300PATIENCE/config_FlatNSD_SSSP.yml
